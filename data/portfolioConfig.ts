...
export const config = {
  ...
  projects: [
    ...
    },
    {
      ...
      longDescription: {
        en: 'The Travel-RD mobile app is the companion application for the Travel-RD ecosystem, available for both iOS and Android. Built with Flutter and following Clean Architecture principles, it provides travelers and agencies with a seamless experience to browse destinations, book trips, track drivers in real time, and manage reservations. Offline-first caching ensures a smooth experience even with limited connectivity.',
        es: 'La app móvil de Travel-RD es la aplicación complementaria del ecosistema Travel-RD, disponible para iOS y Android. Construida con Flutter y siguiendo principios de Clean Architecture, ofrece a viajeros y agencias una experiencia fluida para explorar destinos, reservar viajes, rastrear conductores en tiempo real y gestionar reservas. El caché offline garantiza una experiencia suave incluso con conectividad limitada.',
      } as LocalizedString,
    ...
    },
    {
      ...
      longDescription: {
        en: 'Anotar Dominó - Capicúa is a Flutter mobile app that digitizes the experience of tracking dominó games, the most popular card game in the Dominican Republic. Instead of manually counting tiles, players can point their camera at any tile and Gemini AI instantly recognizes its value. The app supports individual and team modes, tracks special plays like Capicúa (winning with double ends), maintains full match history, and integrates AdMob for monetization.',
        es: 'Anotar Dominó - Capicúa es una app Flutter que digitaliza la experiencia de anotar partidas de dominó, el juego de mesa más popular en República Dominicana. En lugar de contar fichas manualmente, los jugadores pueden apuntar la cámara a cualquier ficha y la IA Gemini reconoce su valor al instante. La app soporta modos individual y parejas, registra jugadas especiales como Capicúa (ganar con extremos dobles), mantiene historial completo e integra AdMob para monetización.',
      } as LocalizedString,
      ...
      features: [
        {
          icon: '🤖',
          title: { en: 'Gemini AI Detection', es: 'Detección con Gemini AI' },
          desc: { en: 'Point camera at any tile — Gemini identifies its value instantly.', es: 'Apunta la cámara a una ficha y Gemini identifica su valor al instante.' },
        },
        {
          icon: '👥',
      ...
      stack: [
        { layer: { en: 'Framework', es: 'Framework' }, techs: ['Flutter', 'Dart'] },
        { layer: { en: 'AI & Vision', es: 'IA & Visión' }, techs: ['Gemini API', 'Camera package', 'ML Kit'] },
